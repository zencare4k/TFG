...
function getProxyUrl(properties) {
    ...
    if (proxyHost) {
        const proxyPort = properties[types_1.ScannerProperty.SonarScannerProxyPort] ?? '80';
        ...
        const proxyUrl = new url_1.URL(`http://${proxyUser}:${proxyPassword}@${proxyHost}:${proxyPort}`);
